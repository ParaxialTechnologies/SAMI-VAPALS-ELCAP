:doctitle: VAPALS-ELCAP: SAMI 18-15-16-t1
:numbered:
...
[role="center h1"]
SAMI (VAPALS-ELCAP) 18-15-16-t1
[role="center h3"]
(SAMI*18.0*16 SEQ #15 T1)
...
| Version     | 18-15-16-t1
| Vista ID    | ††SAMI*18.0*16 SEQ #15 T1††: Version 18.0, Patch ID #16, Seq #15, Test 1
| Priority    | High
| Categories  | Routine, File
| Status      | Test Patch: ++sami-18-15-16-t1.zip++
...
SAMI 18-15-16-t1 adds one update, a data-import method for the Philadelphia
VAPALS rollout.
...
|==============================================================================
| File                          | Change
| `sami-18-15-16-t1-recipe.txt` | new
| `sami-18-15-16-t1.txt`        | new
| `sami-18-15-16-t1.kid`        | new
| `sami-18-15-16-t1.zip`        | new
|==============================================================================
...
(link:sami-18-15-16-t1.zip[`sami-18-15-16-t1.zip`]) in advance of the actual install.
...
// (cd ../../../..; ls; ./recipeproc.py --wget --unzip --adoc sami 18-15-16-t1)
-------------------------------------------------------------------------------
$ wget --no-verbose 'http://vistaexpertise.net/newsite/project/vapals-elcap/dist/18-15-16-t1/sami-18-15-16-t1.zip'
{now} URL:http://vistaexpertise.net/newsite/project/vapals-elcap/dist/18-15-16-t1/sami-18-15-16-t1.zip [{size}/{size}] -> "sami-18-15-16-t1.zip" [1]
$ _
-------------------------------------------------------------------------------

Then unzip the archive file with the following command.

// ../../../recipeproc.py --wget --unzip --adoc sami 18-15-16-t1
-------------------------------------------------------------------------------
$ unzip sami-18-15-16-t1.zip
Archive:  sami-18-15-16-t1.zip
  [... 3 files in archive ...]
$ _
-------------------------------------------------------------------------------
...
// ../../../recipeproc.py --rbackcache --adoc sami 18-15-16-t1
-------------------------------------------------------------------------------
>do ^%RO
...
Description: SAMI*18*16 SEQ #15 T1 routine backup

Output routines to
Device: /home/osehra/run/in/sami/18-15-16-t1/sami-18-15-16-t1-back.ro
Parameters? ("WNS") =>
...
// ./recipeproc.py --rbackyotta --adoc sami 18-15-16-t1
-------------------------------------------------------------------------------
>do ^%RO
...
Output device <terminal>: /home/osehra/run/in/sami/18-15-16-t1/sami-18-15-16-t1-back.ro

Header Label: SAMI*18*16 SEQ #15 T1 routine backup
Strip comments <No>?:
SAMIHOM4  SAMIHUL
...
// ./recipeproc.py --loadkids --adoc sami 18-15-16-t1
-------------------------------------------------------------------------------
Select Installation <TEST ACCOUNT> Option: 1  Load a Distribution
Enter a Host File: /home/osehra/run/in/sami/18-15-16-t1/sami-18-15-16-t1.kid

   KIDS Distribution saved on Sep 10, 2021@18:52:20
   Comment: Test Release SAMI*18.0*16 SEQ #15 T1 (sami-18-15-16-t1)
...
// ./recipeproc.py --install --adoc sami 18-15-16-t1
-------------------------------------------------------------------------------
...
Select INSTALL NAME:    SAMI*18.0*16     Loaded from Distribution    [now]
   => Test Release SAMI*18.0*16 SEQ #15 T1 (sami-18-15-16-t1)  ;Created on Sep 10, 2021@18:52:20
...
You now have VAPALS-ELCAP 18-15-16-t1 (††SAMI*18.0*16 SEQ #15 T1††) installed in
