...
:numbered:
:version: 18-14
:va-version: SAMI*18.0*14 SEQ #14
...
| Version     | {version}
| Vista ID    | ††{va-version}††: Version 18.0, Patch ID #14, Seq #14
| Priority    | High
| Categories  | Routine, File
| Status      | Released: ++sami-{version}.zip++
...
(link:sami-18-14.zip[`sami-18-14.zip`]) in advance of the actual install.  In
...
You now have VAPALS-ELCAP 18-14 (††SAMI*18.0*14 SEQ #14††) installed in your M
...
| Developed | 2021-10-13/14         | George P. Lilly (VEN) +
                                      ...
                                      Linda M. R. Yaw (VEN)
| Tested    | 2021-10-14/24         | George P. Lilly (VEN) +
                                      Dominic DiNatale (PAR) +
                                      Larry G. Carlson (VEN) +
                                      ...
                                      Kenneth W. McGlothlen (VEN) +
                                      Linda M. R. Yaw (VEN)
| Released  | 2021-10-25            | Frederick D. S. Marshall (VEN) +
                                      Kenneth W. McGlothlen (VEN) +
                                      Linda M. R. Yaw (VEN)
|==============================================================================
