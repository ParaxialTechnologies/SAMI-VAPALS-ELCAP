:doctitle: VAPALS-ELCAP: SAMI 18-14-t3
:numbered:
:version: 18-14-t3
:va-version: SAMI*18.0*14 SEQ #14 T3
...
// grep '\$TXT' sami-18-14-t3.txt
-------------------------------------------------------------------------------
$TXT by YAW,LINDA linda.yaw@vistaexpertise.net (KIDS) 2021-10-06t03:52z
-------------------------------------------------------------------------------
...
SAMI {version} adds 17 updates, most of them changes to the user reports.
...
* High-priority changes and bugfixes (<<fix-1,1>>, <<fix-2,2>>, <<fix-3,3>>,
  ...
  <<fix-10,10>>, <<fix-11,11>>, <<fix-12,12>>);
* Medium-priority changes and bugfixes (<<fix-13,13>>, <<fix-14,14>>,
  <<fix-15,15>>, <<fix-16,16>>, <<fix-17,17>>)
...
(link:sami-18-14-t3.zip[`sami-18-14-t3.zip`]) in advance of the actual install.
...
-------------------------------------------------------------------------------
$ unzip sami-18-14-t3.zip
Archive:  sami-18-14-t3.zip
  [... 441 files in archive, about 9.7 Mb ...]
$ _
-------------------------------------------------------------------------------
...
Description: SAMI*18*14 SEQ #14 T3 routine backup

Output routines to
Device: /home/osehra/run/in/sami/18-14/t3/sami-18-14-t3-back.ro
Parameters? ("WNS") =>
Printer Format? No => No
SAMICAS2.INT    SAMICUL.INT     SAMIPAT.INT     SAMIUR.INT
...
Output device <terminal>: /home/osehra/run/in/sami/18-14/t3/sami-18-14-t3-back.ro

Header Label: SAMI*18*14 SEQ #14 T3 routine backup
Strip comments <No>?:
SAMIPAT   SAMIUR    SAMIUR2   SAMIURUL

Total of 3558 lines in 6 routines.
...
Enter a Host File: /home/osehra/run/in/sami/18-14/t3/sami-18-14-t3.kid

   KIDS Distribution saved on Oct 05, 2021@17:58:41
   Comment: Test Release SAMI*18.0*14 SEQ #14 T3 (sami-18-14-t3)
...
Select INSTALL NAME:    SAMI*18.0*14     Loaded from Distribution    [now]
   => Test Release SAMI*18.0*14 SEQ #14 T3 (sami-18-14-t3)  ;Created on Oct 05, 2021@17:58:41
...
Build Distribution Date: Oct 05, 2021
...
You now have VAPALS-ELCAP 18-14-t3 (††SAMI*18.0*14 SEQ #14 T3††) installed in
...
| `SAMIUR`   | `B520612339`      | `B618867768`     | `**5,10,11,12,14**`
| `SAMIUR2`  | `B1265246653`     | `B1360826675`    | `**5,11,12,14**`
| `SAMIURUL` | `B98717`          | `B103109`        | `**12,14**`
|==============================================================================
...
|==============================================================================
|           | Dates                 | By
| Developed | 2021-10-01/05         | George P. Lilly (VEN) +
                                      Dominic DiNatale (PAR) +
                                      Larry G. Carlson (VEN) +
                                      Frederick D. S. Marshall (VEN) +
                                      Kenneth W. McGlothlen (VEN) +
                                      Linda M. R. Yaw (VEN)
| Tested    | 2021-10-04/05         | George P. Lilly (VEN) +
                                      Dominic DiNatale (PAR) +
                                      Larry G. Carlson (VEN) +
                                      ...
                                      Kenneth W. McGlothlen (VEN) +
                                      Linda M. R. Yaw (VEN)
| Released  | 2021-10-05            | Frederick D. S. Marshall (VEN) +
                                      Kenneth W. McGlothlen (VEN) +
                                      Linda M. R. Yaw (VEN)
|==============================================================================
