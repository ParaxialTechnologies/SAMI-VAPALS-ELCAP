...
-------------------------------------------------------------------------------
$TXT by YAW,LINDA linda.yaw@vistaexpertise.net (KIDS) 2021-10-07t21:11z
-------------------------------------------------------------------------------
...
SAMI {version} adds 18 updates, most of them changes to the user reports.
...
* High-priority changes and bugfixes (<<fix-1,1>>, <<fix-2,2>>, <<fix-3,3>>,
  ...
  <<fix-10,10>>, <<fix-11,11>>, <<fix-12,12>>, <<fix-13,13>>);
* Medium-priority changes and bugfixes (<<fix-14,14>>, <<fix-15,15>>,
  <<fix-16,16>>, <<fix-17,17>>, <<fix-18,18>>)
...
Archive:  sami-18-14-t3.zip
  [... 553 files in archive, about 9.7 Mb ...]
$ _
-------------------------------------------------------------------------------
...
Total of 3886 lines in 7 routines.
...
| Tested    | 2021-10-04/06         | George P. Lilly (VEN) +
                                      ...
                                      Kenneth W. McGlothlen (VEN) +
                                      Linda M. R. Yaw (VEN)
| Released  | 2021-10-07            | Frederick D. S. Marshall (VEN) +
                                      Kenneth W. McGlothlen (VEN) +
                                      Linda M. R. Yaw (VEN)
|==============================================================================
