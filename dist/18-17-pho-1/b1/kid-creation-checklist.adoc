...
X   3.8. git pull/push, pull to vapalsyotta
 ...
 4. KIDS Build 
X   4.0 copy all new routines to ~/run/routines just in case, also to routines/after
        in current dist.
X   4.1 In linux cd ~/run/out/sami/ then mkdir 18-17-pho-1 if necessary, cd 18-21
       mkdir b1
