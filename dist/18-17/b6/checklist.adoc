...
X  4.4. export to out dock (Transport distribution) 
		HF: /home/osehra/run/out/sami/18-17/b6/sami-18-17-b6.kid
		Header: Released SAMI*18.0*17 SEQ #17
X  4.5. copy to personal repo, typing following command when you are in the correct
        dist directory: scp 'vapalsyotta:/home/osehra/run/out/sami/18-17/b6/*.kid' ./
...
X   6.2. push archive package to repo
 ...
 7. Test Install
  7.0 Pull to vapalsyotta and move KIDS to ~/run/in/sami/18-17/b6/
  7.1. install on vapalsyotta (& revise if necessary),
  HF: /home/osehra/run/in/sami/18-17/b6/sami-18-17-b6.kid
