:doctitle: SAMI Patching Checklist for 18-18-t1

This version was changed to 18-17-b5 and abandoned before finishing 
...
X  2.3. update routines including second line
X  2.4. push to repo/pull to vapalsyotta
