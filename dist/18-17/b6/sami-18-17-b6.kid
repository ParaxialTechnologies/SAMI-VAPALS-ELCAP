KIDS Distribution saved on Aug 23, 2024@15:59:25
TEST SAMI*18.0*17 SEQ #17
**KIDS**:SAMI*18.0*17^

**INSTALL NAME**
SAMI*18.0*17
"BLD",11518,0)
SAMI*18.0*17^SAMI^0^3240823^n
"BLD",11518,4,0)
^9.64PA^^
"BLD",11518,6.3)
7
...
"RTN","SAMICAS3",2,0)
 ;;18.0;SAMI;**3,9,11,12,15,17**;2020-01-17;Build 7
"RTN","SAMICAS3",3,0)
...
"RTN","SAMICAS4",2,0)
 ;;18.0;SAMI;**17**;2020-01-17;Build 7
"RTN","SAMICAS4",3,0)
...
"RTN","SAMICSV",2,0)
 ;;18.0;SAMI;**7,11,17**;2020-01-17;Build 7
"RTN","SAMICSV",3,0)
...
"RTN","SAMICUL")
0^10^B145904^B136079
"RTN","SAMICUL",1,0)
SAMICUL ;ven/gpl - case review log; 2024-08-22t21:07z
"RTN","SAMICUL",2,0)
 ;;18.0;SAMI;**9,11,12,14,15,17**;2020-01-17;Build 7
"RTN","SAMICUL",3,0)
...
"RTN","SAMIFLD",2,0)
 ;;18.0;SAMI;**10,17**;2020-01-17;Build 7
"RTN","SAMIFLD",3,0)
...
"RTN","SAMIHOM4",2,0)
 ;;18.0;SAMI;**1,4,5,6,9,12,15,16,17**;2020-01-17;Build 7
"RTN","SAMIHOM4",3,0)
...
"RTN","SAMIHUL",2,0)
 ;;18.0;SAMI;**9,12,15,16,17**;2020-01-17;Build 7
"RTN","SAMIHUL",3,0)
...
"RTN","SAMIPAT")
0^3^B16870509^B8328663
"RTN","SAMIPAT",1,0)
SAMIPAT ;ven/toad - init subroutines; 2024-08-22t21:16z
"RTN","SAMIPAT",2,0)
 ;;18.0;SAMI;**12,14,15,17**;2020-01-17;Build 7
"RTN","SAMIPAT",3,0)
...
"RTN","SAMISITE",2,0)
 ;;18.0;SAMI;**5,12,14,17**;2020-01-17;Build 7
"RTN","SAMISITE",3,0)
...
"RTN","SAMIUR",2,0)
 ;;18.0;SAMI;**5,10,11,12,14,15,17**;2020-01-17;Build 7
"RTN","SAMIUR",3,0)
...
"RTN","SAMIUR2",2,0)
 ;;18.0;SAMI;**5,11,12,14,15,17**;2020-01-17;Build 7
"RTN","SAMIUR2",3,0)
