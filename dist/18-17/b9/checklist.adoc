:doctitle: SAMI Patching Checklist for 18-17-b9

[role="h1 center"]
SAMI Patching Checklist for 18-17-b9
...
X 4. KIDS Build 
  4.1 In linux cd ~/run/out/sami/18-17/ then mkdir b8
  4.2. Re-enter mumps
...
X 6. Create Zip package
 ...
 7. Test Install
 X 7.0 Pull to vapalsyotta and move KIDS to ~/run/in/sami/18-17/b9/
       Move zip file and then unxip
  7.1. install on vapalsyotta (& revise if necessary),
  HF: /home/osehra/run/in/sami/18-17/b9/sami-18-17-b9.kid
