KIDS Distribution saved on Sep 10, 2024@17:21:14
...
"RTN","SAMICUL")
0^10^B147284^B136079
"RTN","SAMICUL",1,0)
SAMICUL ;ven/gpl - case review log; 2024-09-03t23:26z
"RTN","SAMICUL",2,0)
 ;;18.0;SAMI;**9,11,12,14,15,17**;2020-01-17;Build 10
"RTN","SAMICUL",3,0)
 ;mdc-e1;SAMICUL-20240903-E2pffz;SAMI-18-17-b9
"RTN","SAMICUL",4,0)
...
"RTN","SAMIDCM1")
0^11^B200371935^B102701967
"RTN","SAMIDCM1",1,0)
SAMIDCM1 ;ven/gpl - import patient from siemens ai; 2024-08-22t21:08z
"RTN","SAMIDCM1",2,0)
 ;;18.0;SAMI;**16,17**;2020-01-17;Build 10
"RTN","SAMIDCM1",3,0)
 ;mdc-e1;SAMIDCM1-20240822-ErbJMe;SAMI-18-17-b9
"RTN","SAMIDCM1",4,0)
...
"RTN","SAMIFUL")
0^13^B129814^B129116
"RTN","SAMIFUL",1,0)
SAMIFUL ;ven/gpl - form log; 2024-08-22t21:10z
"RTN","SAMIFUL",2,0)
 ;;18.0;SAMI;**10,17**;2020-01-17;Build 10
"RTN","SAMIFUL",3,0)
 ;mdc-e1;SAMIFUL-20240822-E3%z%25;SAMI-18-17-b9
"RTN","SAMIFUL",4,0)
...
"RTN","SAMIHOM4")
0^14^B1262443514^B977083192
"RTN","SAMIHOM4",1,0)
SAMIHOM4 ;ven/gpl - homepage web services; 2024-08-22t21:11z
"RTN","SAMIHOM4",2,0)
 ;;18.0;SAMI;**1,4,5,6,9,12,15,16,17**;2020-01-17;Build 10
"RTN","SAMIHOM4",3,0)
 ;mdc-e1;SAMIHOM4-20240822-E3R7P91;SAMI-18-17-b9
"RTN","SAMIHOM4",4,0)
...
"RTN","SAMIHUL")
0^15^B131888^B117874
"RTN","SAMIHUL",1,0)
SAMIHUL ;ven/gpl - home page log; 2024-08-21t21:13z
"RTN","SAMIHUL",2,0)
 ;;18.0;SAMI;**9,12,15,16,17**;2020-01-17;Build 10
"RTN","SAMIHUL",3,0)
 ;mdc-e1;SAMIHUL-20240822-EQzKao;SAMI-18-17-b9
"RTN","SAMIHUL",4,0)
...
"RTN","SAMIPAT")
0^3^B17344032^B8328663
"RTN","SAMIPAT",1,0)
SAMIPAT ;ven/toad - post subroutines; 2024-08-30t03:30z
"RTN","SAMIPAT",2,0)
 ;;18.0;SAMI;**12,14,15,17**;2020-01-17;Build 10
"RTN","SAMIPAT",3,0)
 ;mdc-e1;SAMIPAT-20240822-E2tdr5N;SAMI-18-17-b9
"RTN","SAMIPAT",4,0)
...
"RTN","SAMISITE")
0^16^B212460993^B96347521
"RTN","SAMISITE",1,0)
SAMISITE ;ven/gpl - site signon & security; 2024-08-22t21:17z
"RTN","SAMISITE",2,0)
 ;;18.0;SAMI;**5,12,14,17**;2020-01-17;Build 10
"RTN","SAMISITE",3,0)
...
EOR ; end of SAMIUR
"RTN","SAMIUR2")
0^5^B1536139436^B1367473447
"RTN","SAMIUR2",1,0)
SAMIUR2 ;ven/gpl - user reports cont; 2024-08-22t21:20z
"RTN","SAMIUR2",2,0)
 ;;18.0;SAMI;**5,11,12,14,15,17**;2020-01-17;Build 10
"RTN","SAMIUR2",3,0)
 ;mdc-e1;SAMIUR2-20240822-E3rWVeB;SAMI-18-17-b9
"RTN","SAMIUR2",4,0)
...
"RTN","SAMIURUL",2,0)
 ;;18.0;SAMI;**12,14,15,17**;2020-01-17;Build 10
"RTN","SAMIURUL",3,0)
 ;mdc-e1;SAMIURUL-20240822-E1h%GJK;SAMI-18-17-b9
"RTN","SAMIURUL",4,0)
