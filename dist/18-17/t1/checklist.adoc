:doctitle: SAMI Patching Checklist for 18-17-t1
...
X  4.3. Create KIDS build (XPD MAIN Menu) (<Esc>OPE to get out of an entry screen)
  		SAMI 18.0T05 -- don't include SAMI*18.0*7 nor SAMI*18.0*14 in required 
  		builds
X  4.4. export to out dock (Transport distribution) 
		HF is /home/osehra/run/out/sami/18-17/t1/sami-18-17-t1.kid
		Header: Test release SAMI*18.0*17 SEQ #17 T1
X  4.5. copy to personal repo scp 'vapalsyotta:/home/osehra/run/out/sami/18-17/t1/*.kid' ./
