...
:vista-longversion: Version 18.0, Patch ID #17, Seq #17, Test 1
:nmsp: SAMI
:lnmsp: sami
:appname: VAPALS-ELCAP
:va-version: {nmsp}*18.0*17 SEQ #17 T1
:priority: High
...
// grep '\$TXT' sami-18-17-t1.txt
-------------------------------------------------------------------------------
$TXT by YAW,LINDA linda.yaw@vistaexpertise.net (KIDS) 2022-06-20t21:19z
-------------------------------------------------------------------------------
...
{nmsp} {version} adds one high-priority update in preparation for single
