...
:doctitle: 18-20-b1 – Screening+ – Projects – Vista Expertise Network
...
:lnmsp: sami
:appname: Screening+
:va-version: {nmsp}*18.0*20 SEQ #20 b1
:vista-longversion: Version 18.0, Patch ID #20, Seq #20, Build 1
:priority: High
:categories: Routine, File
:status: Release

// grep '\$TXT' sami-18-20-b1.txt
-------------------------------------------------------------------------------
...
Select INSTALL NAME: SAMI*18.0*20⮐       Loaded from Distribution    [datetime]
     => Released SAMI*18.0*20 SEQ #20  ;Created on [datetime]
...
PACKAGE: SAMI*18.0*20     [datetime]                                    PAGE 1
‍‍-------------------------------------------------------------------------------
