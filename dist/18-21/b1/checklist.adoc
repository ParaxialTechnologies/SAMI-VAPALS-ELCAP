...
X   3.6. update recipe with after information
 ...
 4. KIDS Build 
   4.0 copy all new routines to ~/run/routines just in case
   4.1 In linux cd ~/run/out/sami/ then mkdir 18-20 if necessary, cd 18-20
       mkdir b1
   4.2. Re-enter mumps
   ...
   4.4. export to out dock (Transport distribution) 
		HF: /home/osehra/run/out/sami/18-20/b1/sami-18-20-b1.kid
		Header: Released SAMI*18.0*20 SEQ #20
   4.5. copy to personal repo, typing following command when you are in the correct
        dist directory: scp 'vapalsyotta:/home/osehra/run/out/sami/18-20/b1/*.kid' ./
    4.6. Add before checksums to .kid file
    4.7. push to sami repo, pull to vapalsyotta in 
 ...
 or from 18-19-b1.txt
  ...
  HF: /home/osehra/run/in/sami/18-20/b1/sami-18-20-b1.kid
...
Enter a Host File: /home/osehra/run/out/sami/18-20/b1/sami-18-20-b1.kid
Header Comment: Released SAMI*18.0*20 SEQ #20
