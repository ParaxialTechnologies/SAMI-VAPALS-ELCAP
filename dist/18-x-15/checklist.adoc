:doctitle: SAMI Patching Checklist for 18-15
...
X  1.2. prepare checklist
  ...
  1.10. update recipe with before checksums  do recipe^ARJTXRW
 ...
 4. KIDS Build
  ...
  4.5. copy to personal repo scp 'vapalsyotta:/home/osehra/run/out/sami/18-x-15/t2/*.kid' ./
