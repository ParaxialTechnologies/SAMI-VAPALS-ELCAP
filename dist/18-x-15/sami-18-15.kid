KIDS Distribution saved on Dec 09, 2021@19:39:25
...
^311.141^6^7
"DATA",311.14,3,1,1,0)
samiSystemVersion^sami-18-15-t2
"DATA",311.14,3,1,2,0)
...
"RTN","SAMICAS3",2,0)
 ;;18.0;SAMI;**3,9,11,12,15**;2020-01;Build 4
"RTN","SAMICAS3",3,0)
 ;;18-15
"RTN","SAMICAS3",4,0)
 ;
...
"RTN","SAMICTD2",2,0)
 ;;18.0;SAMI;**12,15**;2020-01;Build 4
"RTN","SAMICTD2",3,0)
 ;;18-15
"RTN","SAMICTD2",4,0)
 ;
...
"RTN","SAMICTT0",2,0)
 ;;18.0;SAMI;**4,10,11,15**;2020-01;Build 4
"RTN","SAMICTT0",3,0)
 ;;18-15
"RTN","SAMICTT0",4,0)
 ;
...
"RTN","SAMICTT3",2,0)
 ;;18.0;SAMI;**4,10,13,15**;2020-01;Build 4
"RTN","SAMICTT3",3,0)
 ;;18-15
"RTN","SAMICTT3",4,0)
 ;
...
"RTN","SAMICTUL",2,0)
 ;;18.0;SAMI;**10,11,12,13,15**;2020-01;Build 4
"RTN","SAMICTUL",3,0)
 ;;18.15
"RTN","SAMICTUL",4,0)
 ;
...
"RTN","SAMICUL",2,0)
 ;;18.0;SAMI;**9,11,12,14,15**;2020-01;Build 4
"RTN","SAMICUL",3,0)
 ;;18.15
"RTN","SAMICUL",4,0)
 ;
...
"RTN","SAMIHOM4",2,0)
 ;;18.0;SAMI;**1,4,5,6,9,12,15,16**;2020-01;Build 4
"RTN","SAMIHOM4",3,0)
 ;18-15
"RTN","SAMIHOM4",4,0)
 ;
...
"RTN","SAMIHUL",2,0)
 ;;18.0;SAMI;**9,12,15,16**;2020-01;Build 4
"RTN","SAMIHUL",3,0)
 ;18-15
"RTN","SAMIHUL",4,0)
 ;
...
"RTN","SAMINOT1",2,0)
 ;;18.0;SAMI;**2,6,8,10,11,12,15**;2020-01;Build 4
"RTN","SAMINOT1",3,0)
 ;;18-15
"RTN","SAMINOT1",4,0)
 ;
...
"RTN","SAMINOT2",2,0)
 ;;18.0;SAMI;**1,9,12,15**;2020-01;Build 4
"RTN","SAMINOT2",3,0)
 ;;18-15
"RTN","SAMINOT2",4,0)
 ;
...
"RTN","SAMINUL",2,0)
 ;;18.0;SAMI;**9,10,11,12,15**;2020-01;Build 4
"RTN","SAMINUL",3,0)
 ;;18-15
"RTN","SAMINUL",4,0)
 ;
...
"RTN","SAMIPAT",2,0)
 ;;18.0;SAMI;**12,14,15**;2020-01;Build 4
"RTN","SAMIPAT",3,0)
 ;;18-15
"RTN","SAMIPAT",4,0)
 ;
...
"RTN","SAMIUR2",2,0)
 ;;18.0;SAMI;**5,11,12,14,15**;2020-01;Build 4
"RTN","SAMIUR2",3,0)
 ;;18-15
"RTN","SAMIUR2",4,0)
 ;
