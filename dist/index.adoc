...
| link:18-21/b1/[SAMI 18-21]     | 2025-01-23
| __Prerelease__. Add cxform, generate spreadsheets from current MSH files, etc.
| link:18-20/b1/[SAMI 18-20]     | 2024-11-11
| __Released__. MRN Update to CSV Export and Image Upload, Data Dump Fix.
| link:18-19/b1/[SAMI 18-19]     | 2024-09-25
| __Released__. CT Evaluation Report Improvements: Various changes and fixes to
  the CT Evaluation Report per request, and allows moving patients to another
  site.
| link:18-18/b1/[SAMI 18-18]     | 2024-09-12
| __Released__. Patient ID Changes and Document Upload: Adds MRN lookup,
  uploading and viewing outside documents, and uses StudyID throughout the
  application.
...
| __Unreleased__. Initial Data Import: Includes a new intake-data conversion
  for new installations, and duplicate-merging tests, as well as new
  data-import capabilities for RedCap-based lung cancer screening systems.
