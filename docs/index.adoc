...
** link:www/elcap-background-form.html[Draft in progress]
** link:www/elcap-background-form-2.html[Proposed revision in progress]
** link:elcap-forms/elcap-background-form-dd.html[Data dictionary], compiled from the spreadsheet (with annotations, including problems noted).
* Intake form (††siform††):
