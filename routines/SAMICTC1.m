...
CTCOPY(FROM,TO,key) ; copies a Ct Eval form selectively
 ...
 e  d  ;
 . n cei,isnew,savals
 . s savals("pw")="" ; Prev seen, resolved
 . s savals("px")="" ; Prev seen, not a nodule 
 . s savals("pr")="" ; Prev seen, resected
 . s savals("pk")="" ; Not in outside report
 . s savals("pv")="" ; Not included in scan
 . f cei=1:1:9 d  ;
 . . s isnew=$g(@FROM@("cect"_cei_"ch"))
 . . i $d(savals(isnew)) s @TO@("cect"_cei_"ch")=isnew
 ;
