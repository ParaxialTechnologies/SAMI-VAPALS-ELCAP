SAMIUTN1 ;ven/lgc - UNIT TEST for SAMINOT1 ;Jan 17, 2020@08:44
 ;;18.0;SAMI;;
 ;
...
UTMKPRE ; @TEST - Testing pre note
 ...
 N SAMIUARC,SAMIUPOO
 M SAMIUARC=@root@("graph",SAMISID,SAMIFORM,"note")
 K ^KBAP("SAMIUTN1","UTMKPRE")
 M ^KBAP("SAMIUTN1","UTMKPRE")=SAMIUARC
...
UTELNOTE ; @TEST - Testing elegibility note text
 ...
 K ^KBAP("SAMIUTN1","UTELNOTE")
 M ^KBAP("SAMIUTN1","UTELNOTE")=SAMIUPOO
...
UTINNOTE ; @TEST - Testing intake note text
 ...
 K ^KBAP("SAMIUTN1","UTINNOTE")
 M ^KBAP("SAMIUTN1","UTINNOTE")=SAMIUPOO
