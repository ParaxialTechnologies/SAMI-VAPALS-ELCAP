SAMIUTR2 ;ven/lgc - UNIT TEST for SAMICTR2 ;Jan 17, 2020@09:33
 ;;18.0;SAMI;;
 ;
...
UTOTLNG ; @TEST - other lung
 ...
 K ^KBAP("SAMIUTR2","UTOTLNG1021")
 M ^KBAP("SAMIUTR2","UTOTLNG1021")=return
 ...
 s para="POO"
 d OTHRLUNG^SAMICTR2("return",vals,dict)
 K ^KBAP("SAMIUTR2","UTOTLNG1203")
 M ^KBAP("SAMIUTR2","UTOTLNG1203")=return
 ;now pull saved report
 ...
 s para="POO"
 d OTHRLUNG^SAMICTR2("return",vals,dict)
 K ^KBAP("SAMIUTR2","UTOTLNG0123")
 M ^KBAP("SAMIUTR2","UTOTLNG0123")=return
 ;now pull saved report
 ...
 s para="POO"
 d OTHRLUNG^SAMICTR2("return",vals,dict)
 K ^KBAP("SAMIUTR2","UTOTLNG0225")
 M ^KBAP("SAMIUTR2","UTOTLNG0225")=return
 ;now pull saved report
 ...
 s para="POO"
 d OTHRLUNG^SAMICTR2("return",vals,dict)
 K ^KBAP("SAMIUTR2","UTOTLNG0226")
 M ^KBAP("SAMIUTR2","UTOTLNG0226")=return
 ;now pull saved report
 ...
 s para="POO"
 d OTHRLUNG^SAMICTR2("return",vals,dict)
 K ^KBAP("SAMIUTR2","UTOTLNG0312")
 M ^KBAP("SAMIUTR2","UTOTLNG0312")=return
 ;now pull saved report
