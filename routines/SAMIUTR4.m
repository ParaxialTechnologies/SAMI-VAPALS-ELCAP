SAMIUTR4 ;ven/lgc - UNIT TEST for SAMICTR4 ; 10/26/18 6:03pm
 ;;18.0;SAMI;;
 ;
...
UTXVAL ; @TEST - extrinsic returns the patient value for var
 ...
 s utsuccess=($$xval^SAMICTR4(1,"arc")="Testing xval")
