SAMIUTR6 ;ven/lgc - UNIT TEST for SAMICTR6 ; 10/26/18 6:08pm
 ;;18.0;SAMI;;
 ;
 ;
...
UTXVAL ; @TEST - extrinsic returns the patient value for var
 ...
 s utsuccess=($$xval^SAMICTR6(1,"arc")="Testing xval")
