SAMIUTR7 ;ven/lgc - UNIT TEST for SAMICTR7 ; 10/26/18 6:10pm
 ;;18.0;SAMI;;
 ;
...
SHUTDOWN ; ZEXCEPT: utsuccess
 ...
 ;
 ;
UTPERCD ; @TEST - pericardial
 ;paricardial(rtn,vals,dict)
 q
UTOUT ; @TEST - out line
 ;out(ln)
 n cnt,rtn,poo
...
UTXVAL ; @TEST - extrinsic returns the patient value for var
 ...
 s utsuccess=($$xval^SAMICTR7(1,"arc")="Testing xval")
