XWBUTCLR ; SIC/SMH - RPC Broker in M;2018-08-29  3:16 PM ; 2/2/19 1:37pm
...
XWBTEST ; @TEST XWB Broker Full Example
 ...
 ;
 ; 3. Get Intro Message
 D WRITE^XWBCLRPC($$RPC^XWBCLRPC("XUS INTRO MSG")),WBF^XEBCLRPC
 S X=$$READ^XWBCLRPC() D CONSOLE^XWBCLRPC(X)
 D CONSOLE^XWBCLRPC($$NOW^XLFDT)
 ;
