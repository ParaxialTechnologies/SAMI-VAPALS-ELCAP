%webcurl ; VEN/SMH - Web Services Client using cURL ;Feb 07, 2019@10:40
 ;
 ; (c) Sam Habiel 2013-2016
 ;
 ...
 ;
 ; 2019-05-28 ven/lgc routine name changed from %WC to %webcurl
 ;
%(RETURN,METHOD,URL,PAYLOAD,MIME,TO,HEADERS,OPTIONS) ; General call for any type
 ...
 ; W $$%^%webcurl(.RTN,"GET","https://www.google.com")
 ;
